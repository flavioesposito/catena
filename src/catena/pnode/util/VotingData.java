...
import catena.config.CADConfig;
...
public class VotingData {
	...
	/**
	 * @return the _VotingTime
	 */
	public LinkedHashMap<Integer, LinkedHashMap<Integer, Long>> get_VotingTimeMap() {
		return _VotingTimeMap;
	}


	/**
	 * @param _VotingTime the _VotingTime to set
	 */
	public void set_VotingTimeMap(
			LinkedHashMap<Integer, LinkedHashMap<Integer, Long>> _VotingTimeMap) {
		this._VotingTimeMap = _VotingTimeMap;
	}



	/**
	 * @return the _VotingTimeMap (the _VotingTime vector for each sliceID)
	 */
	public LinkedHashMap<Integer, Long> get_VotingTimeVector(int sliceID) {
		return _VotingTimeMap.get(sliceID);
	}
	
	/**
	 *  the _VotingTime vector to set
	 * @param _VotingTimeVector
	 * @param sliceID
	 */
	public void set_VotingTimeVector(LinkedHashMap<Integer, Long> _VotingTimeVector, int sliceID) {
		this._VotingTimeMap.put(sliceID, _VotingTimeVector);
	}
